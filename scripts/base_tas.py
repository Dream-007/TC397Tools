...
JSON_PATH = Path('/home/shiheping/QianLiPrj/TC397Tools/Downloads/MCU_A.json')
MAX_MEMBER_DEPTH = 8
...
class BaseTas:
    ...
    def write_variable_by_signal_id_value(
        self,
        ...
        """修改指定 sigID 的值，并将等长的完整数据写回目标变量。"""
        if not 0 < sig_id <= 0xFFFF:
            raise ValueError(f"sig_id must be in range 1..65535, got {sig_id}")
        updated_data = bytearray(data)
        original_size = len(updated_data)
        offset = 0
        header_size = 4

        while offset + header_size <= original_size:
            current_sig_id = int.from_bytes(
                updated_data[offset : offset + 2],
                "little",
                signed=False,
            )
            if current_sig_id == 0:
            ...
            data_type = updated_data[offset + 3]
            type_info = SIGNAL_DATA_TYPE_FORMATS.get(data_type)
            if data_type == SIGNAL_DATA_TYPE_MAX or type_info is None:
                break

            fmt, value_size = type_info
            value_offset = offset + header_size
            value_end = value_offset + value_size
            if value_end > original_size:
                break

            if current_sig_id == sig_id:
                if isinstance(value, (bytes, bytearray)):
                    encoded_value = bytes(value)
                    if len(encoded_value) != value_size:
                        raise ValueError(
                            f"sigID {sig_id} value requires {value_size} byte(s), "
                            f"got {len(encoded_value)}"
                        )
                else:
                    try:
                        encoded_value = struct.pack(fmt, value)
                    except (OverflowError, struct.error, TypeError) as exc:
                        raise ValueError(
                            f"invalid value {value!r} for sigID {sig_id}, "
                            f"data_type={data_type}"
                        ) from exc

                updated_data[value_offset:value_end] = encoded_value
                if len(updated_data) != original_size:
                    raise RuntimeError("signal data length changed unexpectedly")

                result = bytes(updated_data)
                self.write_variable_info(var_info, result, original_size)
                return result

            offset = value_end

        raise KeyError(f"sigID {sig_id} not found in signal data")
...
if __name__ == "__main__":
    ...
    data = b"Z\x9c\x03\x00\x00\x00\x00\x00]\x9c\x03\x00\x00\x00p\xc1^\x9c\x03\x00\x00\x00pA_\x9c\x03\x05\x00k\x9c\x03\x05\x00l\x9c\x03\x05\x00n\x9c\x03\x00\x00\x00\x00\x00q\x9c\x03\x05\x00\x00\x00\x00\x00\x00\x00\x00\x00{@\x9c\x03\x05\x00A\x9c\x03\x05\x00B\x9c\x03\x05\x00C\x9c\x03\x05\x00E\x9c\x03\x05\x00F\x9c\x03\x05\x00H\x9c\x03\x05\x00J\x9c\x03\x05\x00M\x9c\x03\x05\x01P\x9c\x03\x05\x00Q\x9c\x03\x00\x00\x00\x00\x00R\x9c\x03\x05\x00T\x9c\x03\x05\x00U\x9c\x03\x05\x00V\x9c\x03\x05\x00W\x9c\x03\x00\x00\x00\x00\x00b\x9c\x03\x05\x01j\x9c\x03\x05\x00m\x9c\x03\x05\x01r\x9c\x03\x05\x00s\x9c\x03\x00\x00\x00 \xc1t\x9c\x03\x00\x00\x00 Ay\x9c\x03\x05\x01}\x9c\x03\x05\x00\x89\x9c\x03\x05\x00\x8a\x9c\x03\x05\x00\x8c\x9c\x03\x05\x00\x8d\x9c\x03\x05\x00\x98\x9c\x03\x05\x00\x9a\x9c\x03\x05\x00\x9c\x9c\x03\x05\x00\x9d\x9c\x03\x05\x00\x9e\x9c\x03\x05\x00\x9f\x9c\x03\x00\x00\x00\xc0\xc0\xa0\x9c\x03\x0033K\xc1\xa1\x9c\x03\x00\x00\x00\x00\x00\xa2\x9c\x03\x00=\n\x87@\xa3\x9c\x03\x0033KA\t\x9d\x03\x05\x00\x0e\x9d\x03\x05\x00\x95\x9c\x03\x05\x00\xbd\x9c\x03\x05\x00\x1e\x9d\x03\x05\x00\x1f\x9d\x03\x05\x00\xbe\x9c\x03\x05\x00\xc0\x9c\x03\x00\x00\x00\x